...
export default {
	...
	...{
		...
		plugins: [
			...
			// Removes the empty `.js` theme files generated by webpack,
			// but sets it after WP has generated its `*.asset.php` file.
			// Note: This is used for Theme development, not for Plugin development.
